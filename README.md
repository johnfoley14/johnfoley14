...
💻 Passionate about **software engineering** and **AI research**  

---

### 🌱 Interests
P2P networks, STUN/TURN servers, transformer based models (STT, TTS, LLMs), object detection (YoloV8) 

---
### 🧠 Tech Stack
React, Angular, Python, Java, Typescript, HuggingFace
